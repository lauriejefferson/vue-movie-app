...
<template>
     <header>
      ...
      <path fill="#E1E8ED" d="M31.301 11H4.668a3 3 0 1 0 0 6c.182 0 .357-.023.53-.053L5.182 17l.637 14.004C5.918 33.202 7.8 35 10 35h16c2.2 0 4.082-1.798 4.182-3.996L30.818 17l-.015-.05c.163.027.327.05.498.05a3 3 0 1 0 0-6z"/>
      <path fill="#DA2F47" d="M28.668 17v16.989c.863-.734 1.444-1.796 1.492-2.986L30.84 17h-2.172zm-6 0h3v18h-3zm-6 18V17h3v18zm-6-18h3v18h-3zM5.16 17l.68 14.003c.054 1.342.776 2.528 1.828 3.254V17H5.16z"/>
      <path fill="#99AAB5" d="m5.16 17l.097 2h25.485l.098-2z" opacity=".6"/>
      <path fill="#FFD983" d="M30.929 11.07c.043-.184.071-.373.071-.57c0-.674-.27-1.284-.704-1.733c.422-.266.704-.732.704-1.267a1.5 1.5 0 0 0-2.058-1.39a1.494 1.494 0 0 0-1.052-1.052A1.5 1.5 0 0 0 26.5 3c-.191 0-.372.039-.54.104a2.495 2.495 0 1 0-4.897.94c-.64.113-1.19.469-1.563.969A2.49 2.49 0 0 0 17.5 4A2.5 2.5 0 0 0 15 6.5l.001.012a2.463 2.463 0 0 0-1.047-.466A2.496 2.496 0 0 0 11.5 4a2.496 2.496 0 0 0-2.455 2.055A3.495 3.495 0 0 0 8.5 6A3.5 3.5 0 0 0 5 9.5c0 .545.135 1.054.357 1.514A1.495 1.495 0 0 0 5.5 14h25a1.495 1.495 0 0 0 .429-2.93z"/>
      <g fill="#FFAC33">
      ...
      <path fill="#FFF" d="M4 13v1a1 1 0 0 0 1 1h26a1 1 0 0 0 1-1v-1H4z"/>
  </svg>
            ...
            <nav class="nav">
                <ul class="nav-list">
                    <li class="nav-list-item">
                        <router-link to="/login"><i class="pi pi-user"></i></router-link>
                    </li>
                </ul>
            </nav>
        </div>
